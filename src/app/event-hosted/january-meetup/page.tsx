...
export default function JanuaryMeetupPage() {
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-8">
                ...
                >
                    ...
                    <h1 className="font-space-grotesk text-4xl sm:text-6xl font-black text-gray-900 mb-4 leading-tight">
                        January Meetup: <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#10b981] to-[#3b82f6]">The Inception</span>
                    </h1>
                    ...
                    <div className="flex flex-wrap items-center gap-6 mt-6">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-sm font-bold text-gray-900">25+ Attendees</span>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        >
                            <img
                                src="https://i.postimg.cc/W1yHy8Nb/post_reference.jpg"
                                alt="January Meetup Banner"
                        ...
                        <motion.div {...fadeIn}>
                            ...
                            <div className="prose prose-lg prose-slate max-w-none text-gray-600 leading-relaxed font-medium">
                                <p className="mb-4">
                                    The KanpurAI January Meetup marked the <strong>beginning of our journey</strong>. It was our very first community gathering, bringing together tech enthusiasts, developers, and students from across Kanpur to discuss the future of AI and modern web technologies.
                                </p>
                                <p className="mb-6">
                                    This inaugural event focused on laying the foundation for Kanpur's AI ecosystem:
                                </p>

                                <div className="grid sm:grid-cols-2 gap-4 mb-8">
                                    {[
                                        { icon: Zap, text: "Community Vision", color: "text-[#C9FF3F]" },
                                        { icon: ArrowRight, text: "Next.js & Vercel", color: "text-blue-500" },
                                        { icon: Users, text: "Local AI Talent", color: "text-[#10b981]" },
                                        { icon: Zap, text: "Building Together", color: "text-purple-500" }
                                    ].map((item, i) => (
                        ...
                        >
                            ...
                            <div className="space-y-8 relative">
                                ...
                                {[
                                    { time: "1:30 PM", event: "Check IN", desc: "Arrival and introductions." },
                                    {
                                        time: "1:45 PM",
                                        event: "KanpurAI – The Vision",
                                        desc: "Building a world-class AI ecosystem in UP.",
                                        speaker: "HARSH TRIVEDI"
                                    },
                                    {
                                        time: "2:15 PM",
                                        event: "The Vercel Way & Modern Web",
                                        desc: "Shipping fast with Next.js and Vercel.",
                                        speaker: "SAMARTH MISHRA"
                                    },
                                    {
                                        time: "2:45 PM",
                                        event: "AI/ML Trends 2026",
                                        desc: "Where the industry is heading this year.",
                                        speaker: "PUSHPENDRA GUPTA"
                                    },
                                    {
                                        time: "3:10 PM",
                                        event: "Building for Communities",
                                        desc: "Why community-driven growth is the future.",
                                        speaker: "PIYUSH SAHU"
                                    },
                                    { time: "3:30 PM", event: "Wrap up & Networking", desc: "Connecting with fellow builders." }
                                ].map((item, idx) => (
                        ...
                        <div className="pt-8 border-t border-gray-100">
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                                {[
                                    "https://i.postimg.cc/4dCR38pR/jan-meetup.jpg",
                                    "https://i.postimg.cc/76vrLBSy/jan-meetup2.jpg",
                                    "https://i.postimg.cc/k4rP5jW9/jan-meetup3.jpg",
                                    "https://i.postimg.cc/fL4QbHYN/IMG_20260110_121531548_HDR.jpg",
                                    "https://i.postimg.cc/DZV3zC1v/IMG_20260110_134149585_HDR_AE.jpg",
                                    "https://i.postimg.cc/50cWtP89/IMG_20260110_143457828_HDR.jpg",
                                ...
                                <div className="space-y-6">
                                    <div className="flex gap-4">
                                        <div className="w-12 h-12 rounded-xl bg-gray-50 border border-gray-100 flex flex-col items-center justify-center shrink-0">
                                            <span className="text-[10px] font-bold text-gray-400 uppercase leading-none mb-1">JAN</span>
                                            <span className="text-lg font-black text-gray-900 leading-none">19</span>
                                        </div>
                                        <div>
                                            <div className="text-gray-900 font-black">Sunday, Jan 19, 2026</div>
                                            <div className="text-gray-500 text-sm font-medium">1:30 PM - 3:30 PM IST</div>
                                        </div>
                                    </div>
